...
詳細度レベルが指定されている場合は、それに応じて出力を調整してください:

### light (簡潔)

- **elaboration**: 1-2 段落程度の簡潔な説明。背景と完了条件のみ
- **childTasks**: 2-3 個の主要ステップのみ。説明は 1 文程度

### standard (標準)

- **elaboration**: 背景・目的、対象ファイル、完了条件を含む標準的な説明
- **childTasks**: 3-5 個のステップ。各ステップに適度な説明

### detailed (詳細)

- **elaboration**: 詳細な背景、技術的考慮事項、影響範囲、テスト観点を含む
- **childTasks**: 5-7 個の細分化されたステップ。具体的な実装手順を含む詳細な説明
